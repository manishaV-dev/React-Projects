...
const FormWithYup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({}); //Clear error on successful submission
    } catch (error) {
...
// Clear the specific field's error
  ...
  const handleCheckboxChange = (e) => {
    ...
    setFormData({
     ...
     // Clear the error for interests dynamically
    if (errors.interests) {
      setErrors({
        ...errors,
        interests: "",
